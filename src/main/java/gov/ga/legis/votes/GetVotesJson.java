...
@XmlRootElement(name = "GetVotesJson")
public class GetVotesJson {

    @XmlElementRef(name = "Branch", namespace = "http://www.legis.ga.gov/2009/01/01/services/", type = JAXBElement.class, required = false)
