...
@XmlRootElement(name = "GetCommitteesByTypeAndSessionJson")
public class GetCommitteesByTypeAndSessionJson {

    @XmlElementRef(name = "Type", namespace = "http://www.legis.ga.gov/2009/01/01/services/", type = JAXBElement.class, required = false)
