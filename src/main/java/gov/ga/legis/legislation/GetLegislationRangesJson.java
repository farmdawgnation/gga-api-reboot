 ...
 *         &lt;element name="RangeSize" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "GetLegislationRangesJson")
public class GetLegislationRangesJson {
    ...
    @XmlElementRef(name = "RangeSize", namespace = "http://www.legis.ga.gov/2009/01/01/services/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> rangeSize;
     ...
     *     
     */
    public JAXBElement<String> getRangeSize() {
        return rangeSize;
    }
     ...
     *     
     */
    public void setRangeSize(JAXBElement<String> value) {
