...
@XmlRootElement(name = "GetLegislationSearchResultsPagedQuerystringXml")
public class GetLegislationSearchResultsPagedQuerystringXml {
    ...
    @XmlElementRef(name = "StatusId", namespace = "http://www.legis.ga.gov/2009/01/01/services/", type = JAXBElement.class, required = false)
