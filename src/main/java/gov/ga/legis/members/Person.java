...
@XmlType(name = "Person", namespace = "http://www.legis.ga.gov/2009/01/01/data/", propOrder = {
    "address",
    "birthday",
    "education",
    "name",
...
public class Person {
    ...
    @XmlElementRef(name = "Birthday", namespace = "http://www.legis.ga.gov/2009/01/01/data/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> birthday;
    @XmlElementRef(name = "Education", namespace = "http://www.legis.ga.gov/2009/01/01/data/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> education;
    @XmlElement(name = "Name")
    protected Name name;
    @XmlElementRef(name = "Occupation", namespace = "http://www.legis.ga.gov/2009/01/01/data/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> occupation;
    @XmlElementRef(name = "Religion", namespace = "http://www.legis.ga.gov/2009/01/01/data/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> religion;
    @XmlElementRef(name = "Spouse", namespace = "http://www.legis.ga.gov/2009/01/01/data/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> spouse;
     ...
     *     
     */
    public JAXBElement<String> getSpouse() {
        return spouse;
    }
     ...
     *     
     */
    public void setSpouse(JAXBElement<String> value) {
        this.spouse = value;
    }
